...
SUPABASE_PROD_URL=your_production_url
...
## 🗄️ Phase 5: Supabase Initialization

### 5.1 Initialize Supabase Project

- [ ] Run `supabase init`
- [ ] Choose project name: `el-backend`

### 5.2 Configure Supabase

- [ ] Update `supabase/config.toml` with production settings:

```toml
# Add these storage bucket configurations
[storage.buckets.audio-recordings]
public = false
file_size_limit = "100MiB"
allowed_mime_types = ["audio/mpeg", "audio/wav", "audio/m4a", "audio/aac"]
objects_path = "./storage/audio-recordings"

[storage.buckets.audio-segments]
public = false
file_size_limit = "50MiB"
allowed_mime_types = ["audio/mpeg", "audio/wav", "audio/m4a", "audio/aac"]
objects_path = "./storage/audio-segments"

[storage.buckets.exports]
public = false
file_size_limit = "200MiB"
allowed_mime_types = ["audio/mpeg", "audio/wav", "audio/zip"]
objects_path = "./storage/exports"
```

### 5.3 Create Supabase Directory Structure

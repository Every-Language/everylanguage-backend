...
CREATE POLICY "Users can view their own bible_versions" ON bible_versions FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own bible_versions" ON bible_versions
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own verses" ON verses FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own verses" ON verses
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own regions" ON regions FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own region_aliases" ON region_aliases FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own region_aliases" ON region_aliases
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own region_sources" ON region_sources FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own region_sources" ON region_sources
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own region_properties" ON region_properties FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own region_properties" ON region_properties
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own language_entities_regions" ON language_entities_regions FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own language_entities_regions" ON language_entities_regions
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own language_entity_sources" ON language_entity_sources FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own language_entity_sources" ON language_entity_sources
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own language_aliases" ON language_aliases FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own language_aliases" ON language_aliases
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can view their own language_properties" ON language_properties FOR
SELECT
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can update their own language_properties" ON language_properties
FOR UPDATE
  USING (
    auth.role () = 'authenticated'
    AND created_by = (
...
CREATE POLICY "Users can delete their own bible_versions" ON bible_versions FOR delete USING (
  auth.role () = 'authenticated'
  AND created_by = (
    SELECT
      id
...
CREATE POLICY "Users can delete their own verses" ON verses FOR delete USING (
  auth.role () = 'authenticated'
  AND created_by = (
    SELECT
      id

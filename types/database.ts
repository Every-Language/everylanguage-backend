  ...
  public: {
    ...
    Functions: {
      ...
      _postgis_selectivity: {
        Args: { att_name: string; mode?: string; geom: unknown; tbl: unknown }
        Returns: number
      }
      _st_3dintersects: {
      ...
      st_angle: {
        Args:
          ...
          | { pt2: unknown; pt3: unknown; pt1: unknown; pt4?: unknown }
        Returns: number
      }
      st_area: {
        Args:
      ...
      st_hexagon: {
        Args: { cell_j: number; cell_i: number; origin?: unknown; size: number }
        Returns: unknown
      }
      st_hexagongrid: {
